    ...
    <div class="flex px-5 h-20 items-center justify-between">
      ...
      <div>
        <div class="relative">
          <input
            type="text"
            class="py-3 px-4 ps-11 block w-96 bg-gray-100 ring-slate-400 border-transparent rounded-lg text-sm focus:border-slate-300 focus:ring-2 focus:ring-slate-400"
            placeholder="Cari"
          />
          <div
      ...
      <div class="flex items-center gap-5">
        ...
        <HPopover v-slot="{ open }" class="relative">
          <HPopoverButton
            :class="open ? 'bg-slate-200' : 'bg-white'"
          ...
          <TransitionScale :scale="0.8" origin="top">
            ...
            >
              <div
                class="overflow-hidden p-3 rounded-lg shadow-lg ring-1 ring-black/5"
              >
